...
import {
    findForum
} from '../forum-middlewares/forum-middlewares';
import sidebar from '../sidebar/sidebar';
import user from '../user/user';
import Article from '../proposal-article/proposal-article';
import ArticleValidated from '../proposal-article-validated/proposal-article-validated';
...
export function show(topic) {
    ...
    if (topic.verified) {
        let article = new ArticleValidated(topic);
